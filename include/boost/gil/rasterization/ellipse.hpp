...
struct midpoint_elliptical_rasterizer
{
        ...
        -> std::vector<std::array<std::ptrdiff_t, 2>>
    {
        ...
        // into additive/subtractive operations.
    ...
    /// \param view - Gil view of image on which the elliptical curve is to be drawn.
    /// \param colour - Constant vector specifying colour intensity values for all channels
    ///                 present in 'view'.
    /// \param center - Array specifying co-ordinates of center of ellipse to be drawn.
    /// \param semi_axes - Array containing lengths of semi-major axis and semi-minor axis
    /// respectively.
    /// \tparam View - Type of input image view.
    template<typename View>
